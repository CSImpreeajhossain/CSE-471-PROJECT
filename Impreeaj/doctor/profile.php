							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<form method="post">
										...
										<input type="submit" name="change_pass" class="btn btn-info my-2" value="Change Password">
									</form>
								</div>
							</div>
						</div>
