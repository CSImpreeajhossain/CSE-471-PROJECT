 					...
 					<div class="row">
 						<div class="col-md-6">
 							...
 							<h5>My Profile</h5>
 							 <form method="post" enctype="multipart/form-data">
 							 	<?php
 							 		echo "<img src='image/".$row['profile']."' class='col-md-12' style='height: 250px;'>"
 						...
 						<div class="col-md-6">
								...
								<?php 
									...
									if (isset($_POST['change'])){
										...
										if (empty($old)) {
											...
											echo "<script>alert('Both Password don't match')</script>";
							...
							<form method="post">
								...
								<input type= "password" name="con_pass" class="form-control" autocomplete="off" placeholder="Enter Confirm New Password">
