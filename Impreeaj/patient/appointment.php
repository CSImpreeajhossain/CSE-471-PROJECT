...
<body style="background-image: url(image/appointment.png); background-size: cover; background-repeat: no-repeat;">
	<?php
				...
				<div class="col-md-10">
					...
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-6 container-fluid bg-dark text-light p-5">
								<form method="post">
									...
									<input type="submit" name="books" class="btn btn-info my-2" value="Book Appointment">
								</form>
							</div>
							<div class="col-md-3"></div>
						</div>
